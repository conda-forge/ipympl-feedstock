...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4793&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipympl-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipympl` can be installed with `conda`:
...
It is possible to list all of the versions of `ipympl` available on your platform with `conda`:
...
```
mamba search ipympl --channel conda-forge
```
...
mamba repoquery search ipympl --channel conda-forge

# List packages depending on `ipympl`:
mamba repoquery whoneeds ipympl --channel conda-forge

# List dependencies of `ipympl`:
mamba repoquery depends ipympl --channel conda-forge
```
